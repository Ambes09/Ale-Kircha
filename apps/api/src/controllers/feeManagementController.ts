...
export class FeeManagementController {
  ...
  async createServiceCharge(request: FastifyRequest, reply: FastifyReply) {
  ...
  async updateServiceCharge(request: FastifyRequest, reply: FastifyReply) {
  ...
  async deleteServiceCharge(request: FastifyRequest, reply: FastifyReply) {
    const { id } = request.params as { id: string };
  ...
  // ==================== DELIVERY CHARGES ====================
  async getDeliveryCharges(request: FastifyRequest, reply: FastifyReply) {
  ...
  async createDeliveryCharge(request: FastifyRequest, reply: FastifyReply) {
    const body = request.body as any;
  ...
  async updateDeliveryCharge(request: FastifyRequest, reply: FastifyReply) {
    const { id } = request.params as { id: string };
    const body = request.body as any;
  ...
  async deleteDeliveryCharge(request: FastifyRequest, reply: FastifyReply) {
    const { id } = request.params as { id: string };
  ...
  async createTaxConfig(request: FastifyRequest, reply: FastifyReply) {
    const body = request.body as any;
  ...
  async updateTaxConfig(request: FastifyRequest, reply: FastifyReply) {
    const { id } = request.params as { id: string };
    const body = request.body as any;
  ...
  async deleteTaxConfig(request: FastifyRequest, reply: FastifyReply) {
    const { id } = request.params as { id: string };
  ...
  async calculateTotalFees(request: FastifyRequest, reply: FastifyReply) {
    const { 
      subtotal, 
      quantity, 
      weight, 
