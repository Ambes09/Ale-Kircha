...
export class ReportController {
  ...
  async getSalesReport(request: FastifyRequest, reply: FastifyReply) {
    ...
    const revenueByType: { [key: string]: { name: string; revenue: number; orders: number } } = {};
    for (const order of orders) {
  ...
  // ==================== ORDER REPORT ====================
  async getOrderReport(request: FastifyRequest, reply: FastifyReply) {
    const { status, customerId, startDate, endDate } = request.query as any;
  ...
  // ==================== PAYMENT REPORT ====================
  async getPaymentReport(request: FastifyRequest, reply: FastifyReply) {
  ...
  // ==================== DELIVERY REPORT ====================
  async getDeliveryReport(request: FastifyRequest, reply: FastifyReply) {
    const { status, startDate, endDate } = request.query as any;
  ...
  // ==================== CUSTOMER REPORT ====================
  async getCustomerReport(request: FastifyRequest, reply: FastifyReply) {
    const { status, startDate, endDate } = request.query as any;
  ...
  // ==================== KIRCHA GROUP REPORT ====================
  async getGroupReport(request: FastifyRequest, reply: FastifyReply) {
    const { status, startDate, endDate } = request.query as any;
